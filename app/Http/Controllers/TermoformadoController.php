    ...
    public function indexfil( Request $request )
    {
        ...
        if($header == ''){
            ...
            if($id > 0 ){
                ...
                $termoformado = array('termoformado'=> $termo,
                                      'termoDet'    => $termoDet ,
                                      'termoDetC'   => $termoDetC, 
                                      'termoPeso'   => $termoPeso,
                                      'termoArch'   => $termoArch
    ...
    {  $id     = 0;
        ...
        if($header == ''){
            ...
            if($id > 0 ){
                   ...
                   if(isset( $affected)){
                        $resources = array(
                            array("error" => "0", 'mensaje' => "Termoformado generada manera correcta",
                                   'type' => 'success',
                                   'data' => array(
                                                array(
                                                    'terLotSal'=> $terLotSal,
    ...
    public function insTermCierre(Request $request){
        ...
        if($header == ''){
            ...
            if($id > 0 ){
                    ...
                    $resources = array(
                            array("error" => "0", 'mensaje' => "Termoformado generado manera correcta",
                                   'type' => 'success')
                        );
                    return response()->json($resources, 200);                    
                 }else{
           ...
           // $filepath = '..\storage\app\public\calidad_archivos\ '. $archivonom;                  
            ...
            if($val > 0){               
               return $resources = array(
                    array("error" => "1", 'mensaje' => "Archivo duplicado",
                           'type' => 'danger')
                    );
            }else{
                ...
                $affected= TermoformadoArch::create([                            
                    ...
                    if(isset( $affected)){
                        $resources = array(
                            array("error" => "0", 'mensaje' => "Archivo guardado de manera correcta",
                                   'type' => 'success')
                            );
                        return response()->json($resources, 200);
                    }else{
            ...
            $nombre = $archivo['nombre'];
             ...
             $valida = TermoformadoArch::all()
                ...
                if(sizeof($valida) <= 0 ){
                      ...
                      $resources = array(
                        array("error" => "1", 'mensaje' => "No existe arhivo",
                        'type'=> 'danger')
                        );
                       return response()->json($resources, 200);
                }else{
                    $affected = TermoformadoArch::
                        where('idTer', $idTer)
                                ...
                                foreach($equivalencia as $equi){
                                    ...
                                    for($i=1 ; $i<=$total ; $i++){
                                        ...
                                        foreach($correlativo as $cor){
                                            ...
                                            if(isset( $affected)){
                                                $resources = array(
                                                    array("error" => "0", 'mensaje' => "Detalle ingresado de manera correcta",
                                                           'type' => 'success')
                                                );
                                            }
                                        }   
            ...
            if($header == ''){                
                ...
                if($id > 0 ){
                        ...
                        if(sizeof($termoDet)>0){            
                            ...
                            $resources = array(
                                           array("error" => "0", 'mensaje' => "Detalle eliminado de manera correcta",
                                            'type' => 'success')
                                        );
                            ...
                            $resources = array(
                                array("error" => "1", 'mensaje' => "Error en eliminar",
                                 'type' => 'danger')
                             );
                    ...
                    if($id > 0 ){
                            ...
                            foreach($termo as $item){
                             ...
                             if($idTer> 0){  
                                ...
                                $resources = array(
                                    array("error" => "0", 'mensaje' => "Termoformado Autorizado",
                                    'type' => 'success')
                                );
                                ...
                                $resources = array(
                                    array("error" => "1", 'mensaje' => "Error en autprizar",
                                    'type' => 'danger')
                                );
                ...
                if($header == ''){                
                    ...
                    if($id > 0 ){
                            ...
                            if($idTer> 0){  
                                ...
                                $resources = array(
                                    array("error" => "0", 'mensaje' => "Termoformado Rechazado",
                                    'type' => 'success')
                                );
                                ...
                                $resources = array(
                                    array("error" => "1", 'mensaje' => "Error en Rechazar",
                                    'type' => 'danger')
                                );
