    ...
    public function indexfil( Request $request )
    {
        ...
        if($header == ''){
            ...
            if($id > 0 ){
                ...
                $inyeccion = array('inyeccion'    => $inyeccion,
    ...
    {  $id     = 0;
        ...
        if($header == ''){
            ...
            if($id > 0 ){
                   ...
                   if(isset( $affected)){
                        $resources = array(
                            array("error" => "0", 'mensaje' => "Inyección generada manera correcta",
                                   'type' => 'success',
                                   'data' => array(
                                                array(
                                                    'inyLotSal'=> $inyLotSal,
    ...
    public function insInyCierre(Request $request){
        ...
        if($header == ''){
            ...
            if($id > 0 ){
                    ...
                    $resources = array(
                            array("error" => "0", 'mensaje' => "Inyeccion generado manera correcta",
                                   'type' => 'success')
                        );
                    return response()->json($resources, 200);                    
                 }else{
                    ...
                    if($id > 0 ){
                            ...
                            foreach($inyeccion as $item){
                             ...
                             if($idIny > 0){  
                                ...
                                $resources = array(
                                    array("error" => "0", 'mensaje' => "Inyeccion Autorizado",
                                    'type' => 'success')
                                );
                                return $resources;                              
                            }else{
                                $resources = array(
                                    array("error" => "1", 'mensaje' => "Error en autorizar",
                                    'type' => 'danger')
                                );
                                return $resources;
                            }
                ...
                if($header == ''){                
                    ...
                    if($id > 0 ){
                            ...
                            if($idIny> 0){  
                                ...
                                $resources = array(
                                    array("error" => "0", 'mensaje' => "Inyeccion Rechazado",
                                    'type' => 'success')
                                );
