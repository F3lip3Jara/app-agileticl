        ...
        if($header == ''){
            ...
            if($id > 0 ){
                ...
                foreach($data as $item){
                   ...
                   if(isset( $affected)){
                        $resources = array(
                            array("error" => "0", 'mensaje' => "Envasado generado manera correcta",
                                   'type' => 'success'
                                             )
        ...
        if($header == ''){
            ...
            if($id > 0 ){
                ...
                $affected = Envasado::where('idEnv', $idEnv)
                   ...
                   if(isset( $affected)){
                        $resources = array(
                            array("error" => "0", 'mensaje' => "Envasado rechazado manera correcta",
                                   'type' => 'danger',
        ...
        if($header == ''){
            ...
            if($id > 0 ){
                ...
                $affected = Envasado::where('idEnv', $idEnv)
                   ...
                   if(isset( $affected)){
                        $resources = array(
                            array("error" => "0", 'mensaje' => "Envasado confirmado manera correcta",
                                   'type' => 'success',
