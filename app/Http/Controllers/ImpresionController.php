    ...
    public function indexfil( Request $request )
    {
        ...
        if($header == ''){
            ...
            if($id > 0 ){
                ...
                $impTinta=ImpresionTintas::select(  DB::raw('imptPrd as idPrd'),                
                ...
                $impresion = array(   'impresion'    => $impresion,
    ...
    {  $id     = 0;
        ...
        if($header == ''){
            ...
            if($id > 0 ){
                   ...
                   if(isset( $affected)){
                        $resources = array(
                            array("error" => "0", 'mensaje' => "impresión generada manera correcta",
                                   'type' => 'success',
                                   'data' => array(
                                                array(
                                                    'impLotSal'=> $impLotSal,
    ...
    public function insImpCierreC(Request $request){
        ...
        if($header == ''){
            ...
            if($id > 0 ){
                    ...
                    $resources = array(
                            array("error" => "0", 'mensaje' => "Impresión generado manera correcta",
                                   'type' => 'success')
                        );
                    return response()->json($resources, 200);                    
                 }else{
                    ...
                    foreach($impresion as $item){
                     ...
                     if($idImp> 0){  
                       $affect = Impresion::where('idImp' , $idImp)->update([
                        ...
                        $resources = array(
                            array("error" => "0", 'mensaje' => "Impresión Autorizado",
                            'type' => 'success')
                        );
                        return $resources;                              
                    }else{
        ...
        if($header == ''){                
            ...
            if($id > 0 ){
                    ...
                    if($idImp> 0){  
                        ...
                        $resources = array(
                            array("error" => "0", 'mensaje' => "Impresión Rechazado",
                            'type' => 'success')
                        );
